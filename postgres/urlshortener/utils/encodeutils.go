...
// The original number will be used to map the character in this base string. Then, the number is divided by 62
// to find out the next characters.
const (
	base = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"
	b    = 62
)

// Function encodes the given database ID to base62 string
