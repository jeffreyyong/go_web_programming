// The thumbnail package produces thumbnail-size images form larger images. Only JPEG images are currently supported
...
func Image(src image.Image) image.Image {
	// compute the thumbnail size, preserving aspect ratio.
...
// It returns teh generated file name, e.g. "foo.thumb.jpeg"
